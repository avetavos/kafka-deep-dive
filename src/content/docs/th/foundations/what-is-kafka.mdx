---
title: 'Kafka คืออะไร'
description: 'Kafka ในฐานะ distributed event streaming platform ตัว log แบบ publish/subscribe ต่างจาก message queue ยังไง และแก้ปัญหาอะไร'
sidebar:
  order: 2
---
...
export const quizWhat = [
  {
    ...
    options: [
      'ลบ message ทิ้งหลัง consumer ตัวหนึ่งอ่านเสร็จ',
      'เป็น log แบบ append-only record ถูกเก็บไว้ ไม่ได้ลบตอนอ่าน และ consumer แต่ละตัว track offset ของตัวเอง',
      'รองรับ consumer ได้แค่ตัวเดียว',
      'เก็บข้อมูลไว้ใน memory เท่านั้น',
    ],
    answer: 1,
  },
  {
