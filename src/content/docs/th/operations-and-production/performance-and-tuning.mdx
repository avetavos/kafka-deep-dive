...
export const quizPerf = [
  ...
  },
  {
    ...
    options: [
      ...
      'ไม่จำกัด parallelism ไม่มีเพดาน',
    ],
    answer: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      'เก็บ cache ใหญ่ใน process และไม่สน OS',
      'ใช้ OS page cache RAM ที่ว่างจึงให้ kernel เสิร์ฟการอ่านล่าสุดจาก memory',
      'อ่านตรงจาก ZooKeeper',
      'cache ทุกอย่างใน JVM heap',
    ],
    answer: 1,
  },
];
