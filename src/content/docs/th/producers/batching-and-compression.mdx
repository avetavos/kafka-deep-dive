...
export const quizBatching = [
  ...
  },
  {
    ...
    options: [
      'expose property linger.ms และ batch.size แบบเดียวกัน',
      'ไม่มีปุ่ม linger/batch-size — รวม message ใน send() ครั้งเดียวเองภายใน ไม่มี linger timer',
      'ไม่ batch record เลย',
