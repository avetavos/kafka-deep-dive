...
export const quizOffsets = [
  ...
  },
  {
    ...
    options: [
      'commit น้อยเกินไปจนไม่มีประโยชน์',
      'commit ตามตารางเวลาโดยไม่สนว่า process สำเร็จหรือไม่ ดังนั้น crash อาจทำ record หาย',
      'ทำ record ซ้ำทุกตัว',
      'ปิดการทำงานของ consume loop',
    ],
    answer: 1,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      'รอจน commit ถูก ack ก่อนไปต่อ — ตัวเลือกที่ปลอดภัย เทียบกับการยิงเบื้องหลังเพื่อ throughput',
      'ลบ offset เก่าออกจาก topic',
      'สร้าง consumer group ใหม่',
    ],
    answer: 1,
  },
];
