...
export const quizConsumerApi = [
  {
    ...
    options: [
      ...
      'ยังส่ง heartbeat, ประสาน group membership และดึง partition assignment ด้วย',
      'commit offset ลงฐานข้อมูล',
  ...
  },
  {
    ...
    options: [
      ...
      'group coordinator จะถือว่าตายแล้ว และ rebalance ย้าย partition ไปให้ consumer ตัวอื่น',
