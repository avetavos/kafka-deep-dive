...
export const quizStreams = [
  ...
  },
  {
    ...
    options: [
      'ไม่รอด — state หายไปเมื่อ restart',
      'ทุก update ถูกเขียนลง changelog topic ด้วย จึงสร้าง store ขึ้นใหม่ได้ด้วยการเล่นซ้ำ',
      'ถูกก๊อปไปยังทุก consumer ด้วยมือ',
      'ถูกเก็บไว้ใน JVM heap ตลอดกาลเท่านั้น',
    ],
    answer: 1,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      'ห่อ read-process-write (รวมถึง state และ offset) ไว้ใน transaction การ retry จึงไม่ apply update ซ้ำสองครั้ง',
      'ปิด state store',
      'เปลี่ยน Kafka Streams ให้เป็น cluster แยกต่างหาก',
    ],
    answer: 1,
  },
];
