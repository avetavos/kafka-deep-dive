...
description: 'A developer-focused deep dive into Apache Kafka 4.x — the log, topics and partitions, producers, consumers, delivery semantics, transactions, and running Kafka in production.'
sidebar:
  order: 1
---
